...
export async function runAnalysis(
  ...
  try {
    console.log('[WORKER] Starting analysis for scan:', scanId, 'textLength:', contractText.length)
    ...
    console.log('[WORKER] Claude responded for scan:', scanId)
    ...
    console.log('[WORKER] Scan complete:', scanId, 'flags:', flags.length)
  } catch (error: any) {
    console.error('[WORKER] Analysis failed for scan:', scanId, error.message || error)
