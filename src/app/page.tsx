            ...
            {useCases.map((uc) => (
              ...
              >
                <CardHeader className="pb-3">
                  <div className="flex items-center justify-center w-12 h-12 rounded-lg bg-sky-100 dark:bg-sky-900/30 mb-3">
                    <uc.icon className="h-6 w-6 text-sky-600 dark:text-sky-400" />
                  </div>
      ...
      <section id="pricing" className="py-20 px-4 bg-muted/30">
        <div className="max-w-3xl mx-auto">
          ...
          <div className="mb-10 text-center">
            <span className="inline-block px-4 py-2 rounded-full bg-sky-100 dark:bg-sky-900/30 text-sky-700 dark:text-sky-300 text-sm font-semibold">
